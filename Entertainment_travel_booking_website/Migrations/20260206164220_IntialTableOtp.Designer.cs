...
namespace Entertainment_travel_booking_website.Migrations
{
    ...
    [Migration("20260206164220_IntialTableOtp")]
    partial class IntialTableOtp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entertainment_travel_booking_website.Models.Trip", b =>
                {
                    ...
                    b.Property<int?>("AdditionalActivityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdditionalActivityId");
            ...
            modelBuilder.Entity("Entertainment_travel_booking_website.Models.Trip", b =>
                {
                    b.HasOne("Entertainment_travel_booking_website.Models.AdditianActivities", "AdditionalActivity")
                        .WithMany("Trips")
                        .HasForeignKey("AdditionalActivityId");

                    b.HasOne("Entertainment_travel_booking_website.Models.Hotel", "Hotel")
                        .WithMany()
                        .HasForeignKey("HotelId");

                    b.Navigation("AdditionalActivity");
